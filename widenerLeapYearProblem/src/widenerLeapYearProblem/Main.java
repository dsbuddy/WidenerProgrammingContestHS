...
// }
	public static void p3() {
        ...
        if (words[0].equals("2")) System.out.println(Math.abs(((Integer.parseInt(words[1].substring(1, 2))) - 7) % 10) + "" + Math.abs(((Integer.parseInt(words[1].substring(3, 4))) - 7) % 10) + "" + Math.abs(((Integer.parseInt(words[1].substring(0, 1))) - 7) % 10) + "" + Math.abs(((Integer.parseInt(words[1].substring(2, 3))) - 7) % 10));
 }
